...
concatenated_fasta_name = 'ipd-mhc-mamu-2022-02-02_fl.fasta'
accession='102908'
rule all:
    input:
...
# rule all:
#     input:
#         "results/07-genotypes/" + accession + ".genotypes.csv",
#         "results/05-merged/" + accession + ".merged.bam",
#         "results/06-depth/" + accession + ".depth.txt.gz"
#     run:
#         shell("rm -rf " + mapping_reference_fasta + " " + individual_allele_fasta_folder)
...
#     output:
#         temp("results/01-bait-mhc/" + accession + ".fastq.gz")
#     params:
#         accession=accession,
...
#     """
#     extract Baylor and WNPRC IDs from SRA accession
#     """
#     output:
#         "results/07-genotypes-fl/" + accession + ".samples.csv"
#     params:
#         accession=accession,
#         fastq_source=fastq_source
#     script:
#         "scripts/sra_utils.py"
